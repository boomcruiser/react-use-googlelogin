 ...
 */
export declare const useGoogleLogin: ({ clientId, hostedDomain, redirectUri, apiKey, scope, cookiePolicy, fetchBasicProfile, uxMode, persist, }: HookConfig) => HookReturnValue;
